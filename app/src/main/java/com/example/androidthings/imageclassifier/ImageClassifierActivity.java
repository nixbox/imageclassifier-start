...
public class ImageClassifierActivity extends Activity {
    ...
    private void doRecognize(Bitmap image) {
        ...
        // Feed the pixels of the image into TensorFlow Neural Network
        ...
        // Extract the output from the Neural Network back into an array
        // of confidence per category
        float[] outputs = new float[Helper.NUM_CLASSES];
        inferenceInterface.fetch(Helper.OUTPUT_NAME, outputs);

        // Send to the callback the results with the highest confidence
        // and their labels
        ...
        mCameraHandler.initializeCamera(this, threadLooper,
                new ImageReader.OnImageAvailableListener() {
                    ...
                    public void onImageAvailable(ImageReader imageReader) {
                        Bitmap bitmap = mImagePreprocessor.preprocessImage(
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mImageView.setImageBitmap(getStaticBitmap());
    }
    ...
    private void onPhotoReady(Bitmap bitmap) {
        // Display the image captured by camera on the LCD
